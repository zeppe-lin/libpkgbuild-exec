...
/*! \brief One exact package-input subject and its concrete host tree. */
...
private:
  ...
  std::vector<package_input_tree> package_inputs_;
...
public:
  ...
  [[nodiscard]] const std::optional<pkgimage::archive_inspection_receipt>&
...
private:
  ...
  std::optional<pkgimage::archive_inspection_receipt> artifact_inspection_;
};
